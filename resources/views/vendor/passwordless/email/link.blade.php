...
<td class="header" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 25px 0; text-align: center;">
        <a href="https://people-as-a-service.com" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #bbbfc3; font-size: 19px; font-weight: bold; text-decoration: none; text-shadow: 0 1px 0 #ffffff;">
            People-as-a-Service
        </a>
    </td>
</tr>
...
<td class="content-cell" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 35px;">
                                        <h1 style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #2F3133; font-size: 19px; font-weight: bold; margin-top: 0; text-align: left;">Hi there!</h1>
<p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787e; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">You can use this to automagically login to people-as-a-service.com using only your email.</p>
...
<p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787e; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">This link will login you into people-as-a-service.com - if you lost your password you can continue using this feature or <a href="{{ route('password.request') }}" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #3869d4;">reset your password</a>.</p>
...
<td class="panel-item" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 0;">
                        <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787e; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left; margin-bottom: 0; padding-bottom: 0;">Please do not reply to this email as it is sent from an unmonitored mailbox and an automated message.</p>
                    </td>
                </tr></table>
</td>
    </tr></table>
...
<td style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
            ...
            If you're having trouble clicking the 'Passwordless Login' button, copy and paste the URL below into your web browser: <br><br>
            {{ $token->getLoginLink() }}
        </p>
        </td>
    </tr></table>
...
<td class="content-cell" align="center" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 35px;">
                    <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; line-height: 1.5em; margin-top: 0; color: #aeaeae; font-size: 12px; text-align: center;">© 2018 PaaS. All rights reserved.</p>
                </td>
            </tr></table>
</td>
</tr>
