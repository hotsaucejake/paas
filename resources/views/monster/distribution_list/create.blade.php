    ...
    <div class="col-lg-12">
        <div class="card card-outline-primary">
            <div class="card-header">
                <h4 class="m-b-0 text-white">Create New Distribution List</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('distribution_list.store') }}" method="POST">
                    @csrf
                    <div class="form-body">
                        <div class="row p-t-20">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control" placeholder="Corus360 Contract Billing Approval" value="{{ old('title') }}" required>
