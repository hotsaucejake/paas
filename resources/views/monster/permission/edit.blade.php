    ...
    <div class="col-lg-12">
        <div class="card card-outline-primary">
            <div class="card-header">
                <h4 class="m-b-0 text-white">Edit Permission</h4>
            </div>
            <div class="card-body">
                        ...
                        <div class="row p-t-20">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control" placeholder="edit_users" value="{{ $permission->name }}" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="guard_name" class="form-control" placeholder="web" value="{{ $permission->guard_name }}" disabled>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
